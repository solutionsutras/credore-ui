...
const Drawee = () => {
	...
	return (
		<h1 className="text-black">No data Avl</h1>
		...
		// 						connection with it will be governed by and construed in
		...
		// 							</p>
		// 							{data.map((item, index) => (
		// 								<p className="text-sm font-bold text-gray-500" key={index}>
		...
		// 					<h3 className="py-5 text-2xl font-semibold">Blockchain</h3>
		...
		// 						<Button className="w-20" onClick={handleShow} color="success">
		// 							Verify
		// 						</Button>
