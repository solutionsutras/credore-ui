...
const TermsAndCondition = () => {
	return (
		<div className="prose prose-sm">
			...
			<p>Welcome to tSmart!</p>

			<p>
				These terms and conditions outline the rules and regulations for the use
				of tSmart's Website, located at https://www.tsmartuk.co.uk/.
			</p>

			<p>
				By accessing this website we assume you accept these terms and
				conditions. Do not continue to use tSmart if you do not agree to take
			...
			<p>
				We employ the use of cookies. By accessing tSmart, you agreed to use
				cookies in agreement with the tSmart's Privacy Policy.{" "}
			</p>
			...
			<p>
				Unless otherwise stated, tSmart and/or its licensors own the
				intellectual property rights for all material on tSmart. All
				intellectual property rights are reserved. You may access this from
				tSmart for your own personal use subjected to restrictions set in these
				terms and conditions.
			</p>

			<p>You must not:</p>
			<ul>
				<li>Republish material from tSmart</li>
				<li>Sell, rent or sub-license material from tSmart</li>
				<li>Reproduce, duplicate or copy material from tSmart</li>
				<li>Redistribute content from tSmart</li>
			</ul>

			<p>
				Parts of this website offer an opportunity for users to post and
				exchange opinions and information in certain areas of the website.
				tSmart does not filter, edit, publish or review Comments prior to their
				presence on the website. Comments do not reflect the views and opinions
				of tSmart,its agents and/or affiliates. Comments reflect the views and
				opinions of the person who post their views and opinions. To the extent
				permitted by applicable laws, tSmart shall not be liable for the
			...
			<p>
				tSmart reserves the right to monitor all Comments and to remove any
			...
			<p>
				You hereby grant tSmart a non-exclusive license to use, reproduce, edit
			...
			<p>
				...
				the hyperlink compensates the absence of tSmart; and (d) the link is in
			...
			<p>
				...
				e-mail to tSmart. Please include your name, your organization name,
			...
			<p>
				No use of tSmart's logo or other artwork will be allowed for linking
